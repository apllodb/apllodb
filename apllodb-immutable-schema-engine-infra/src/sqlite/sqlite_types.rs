...
impl<'repo, 'sess: 'repo> ImmutableSchemaAbstractTypes<'sess, ApllodbImmutableSchemaEngine<'sess>>
...
pub(crate) type VRREntriesInVersion<'vrr, 'sess> =
    apllodb_immutable_schema_engine_domain::version_revision_resolver::vrr_entries_in_version::VRREntriesInVersion<'sess, ApllodbImmutableSchemaEngine<'sess>, SqliteTypes<'vrr, 'sess>>;
