    ...
    let sql_vs_expected_ast: Vec<(&str, SelectCommand)> = vec![
        (
            ...
            SelectCommand::factory(
                ...
                Some(vec![FromItem::factory_tn("t", None)]),
                None,
                None,
                None,
                None,
        ...
        (
            ...
            SelectCommand::factory(
                ...
                Some(vec![
                    FromItem::factory_tn("t1", None),
                    FromItem::factory_tn("t2", None),
                ]),
                None,
                None,
                None,
        ...
        (
            ...
            SelectCommand::factory(
                ...
                Some(vec![FromItem::factory_tn("t", Some("s"))]),
                None,
                None,
                None,
                None,
        ...
        (
            ...
            SelectCommand::factory(
                ...
                Some(vec![FromItem::factory_inner_join(
