...
async fn test_fullscan() {
    SqlTest::default()
        ...
        .add_step(Step::new(
            ...
            StepRes::OkQuery(Box::new(|records| {
                let mut records = records
                    .sorted_by_key(|r| r.get::<i64>(&field("people", "id")).unwrap().unwrap());
        ...
        .add_step(Step::new(
            ...
            StepRes::OkQuery(Box::new(|records| {
                let mut records =
                    records.sorted_by_key(|r| r.get::<i64>(&field("body", "id")).unwrap().unwrap());
        ...
        .add_step(Step::new(
            ...
            StepRes::OkQuery(Box::new(|records| {
                let mut records =
                    records.sorted_by_key(|r| r.get::<i64>(&field("pet", "id")).unwrap().unwrap());
